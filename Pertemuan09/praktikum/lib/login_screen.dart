...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void checkLogin() async {
    ...
    //load username jika remember me aktif
    bool rememberMeStatus = loginData.getBool('rememberMe') ?? false;
    String? savedUsername = loginData.getString('savedUsername');
    
    if (rememberMeStatus && savedUsername != null && savedUsername.isNotEmpty) {
      setState(() {
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (isValidForm) {
                          ...
                          // fungsi remember me
                          if (_rememberMe) {
                            // Simpan username dan status remember me
                            loginData.setString('savedUsername', username);
                            loginData.setBool('rememberMe', true);
                          } else {
                            // Hapus username dan status remember me
